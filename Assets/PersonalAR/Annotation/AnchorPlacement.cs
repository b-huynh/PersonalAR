...
public class AnchorPlacement : MonoBehaviour
{
    ...
    public void SetNextObject(string name)
    {
        ...
        _rightHandPlacer.GetComponent<AnchorActor>().SetDisplayText(_objectToPlace);
        // _rightHandPlacer.GetComponent<IAnchorable>().SetAnchor(_objectToPlace);
        _rightHandPlacer.SetActive(true);

        _leftHandPlacer.GetComponent<AnchorActor>().SetDisplayText(_objectToPlace);
        // _leftHandPlacer.GetComponent<IAnchorable>().SetAnchor(_objectToPlace);
        _leftHandPlacer.SetActive(true);
    }
