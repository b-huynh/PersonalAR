...
//Get Scene Mesh: https://elbruno.com/2017/07/10/hololens-howto-save-a-3d-model-of-the-environment-around-the-device/
...
public class StudyReader : MonoBehaviour
{
    ...
    public int startSessionIndex = 1;
    ...
    void LoadFromJSON()
    {
        ...
        // print("studyObject: "+ studyObject);
        print("num sessions: " + studyObject.sessionRecordings.Length);
