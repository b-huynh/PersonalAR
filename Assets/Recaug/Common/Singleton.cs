    ...
    public class Singleton<T> : MonoBehaviour where T : Singleton<T>
    {
            ...
            get
            {
                if (!IsInitialized && searchForInstance)
                {
                    ...
                    if (objects.Length == 1)
                    {
                        ...
                        DontDestroyOnLoad(GetParentRoot(instance.gameObject));
                    }
        ...
        protected virtual void Awake()
        {
            ...
            else if (!IsInitialized)
            {
                ...
                DontDestroyOnLoad(GetParentRoot(gameObject));
            }
        }
        ...
        // Helper function for getting root parent of an object.
        private static GameObject GetParentRoot(GameObject child)
        {
